 ...
 * @method static string encryptSensitive(mixed $data, string $context = 'general')
 * @method static mixed decryptSensitive(string $encryptedData, string $context = 'general')
