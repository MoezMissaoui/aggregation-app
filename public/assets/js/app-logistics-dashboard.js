...
(function () {
  ...
  // Statistiques des temps d'attente
  // --------------------------------------------------------------------
      ...
      series: [
        {
          ...
          type: 'column',
          data: [15, 18, 12, 14, 16, 20, 18, 15, 17, 14]
        },
        {
          name: 'Nombre de personnes',
          type: 'line',
          data: [45, 52, 38, 42, 48, 60, 55, 45, 50, 42]
        }
      ],
      chart: {
        height: 320,
  ...
  // --------------------------------------------------------------------
  const satisfactionChartEl = document.querySelector('#satisfactionChart'),
  ...
  if (typeof satisfactionChartEl !== undefined && satisfactionChartEl !== null) {
    const satisfactionChart = new ApexCharts(satisfactionChartEl, satisfactionChartConfig);
